...
(function () {
  ...
  const DB = {
    ...
    consumables: [
      ...
      { id: "food_apple",      name: "蘋果",   effect: { sta: 5  }, price: 300,  icon: "https://res.cloudinary.com/dzj7ghbf6/image/upload/v1758721125/%E8%98%8B%E6%9E%9C_lo9q3l.png" },
      { id: "food_strawberry", name: "草莓",   effect: { sta: 3 }, price: 100,  icon: "https://res.cloudinary.com/dzj7ghbf6/image/upload/v1758721125/%E8%8D%89%E8%8E%93_bglsxh.png" },
      { id: "food_banana",     name: "香蕉",   effect: { sta: 6 }, price: 400,  icon: "https://res.cloudinary.com/dzj7ghbf6/image/upload/v1758721125/%E9%A6%99%E8%95%89_emf3e0.png" },
      { id: "food_greenapple", name: "青蘋果", effect: { sta: 8, hp: 10 }, price: 620,  icon: "https://res.cloudinary.com/dzj7ghbf6/image/upload/v1758721125/%E9%9D%92%E8%98%8B%E6%9E%9C_vefoz4.png" },
  ...
  cards: [
    // 刀劍神域-WS SAO/S20系列 ソードアート・オンライン
    {
      ...
      bonus: { hp: 5, mp: 5, atk: 1, spd: 1}
    },
    {
      id: "S20-001S",
      name: "派對邀請函 亞絲娜 SR",
      price: 2000, stackable: true,
      ...
      desc: "WS SAO/S20系列 ソードアート・オンライン",
      bonus: { hp: 10, mp: 10, atk: 2, spd: 2}
    },
    {
      id: "S20-002",
      name: "閃光亞絲娜 RR",
      price: 1500, stackable: true,
    ...
    },
    {
      ...
      bonus: { hp: 50, mp: 50, atk: 30, spd: 20}
    },
    {
      id: "card_water",
      name: "水流卡",
